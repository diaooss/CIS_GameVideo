...
- (id)initWithFrame:(CGRect)frame
{
    ...
    _lastUpdatedLabel = [[UILabel alloc] initWithFrame:CGRectMake(180, 0, 140, 30)];
    _lastUpdatedLabel.backgroundColor = [UIColor clearColor];
    _lastUpdatedLabel.textAlignment = NSTextAlignmentCenter;
    _lastUpdatedLabel.font = [UIFont systemFontOfSize:11.0];
    _lastUpdatedLabel.numberOfLines = 0;
...
{
    _slime.toPoint = _slime.startPoint;
    [UIView transitionWithView:_activityIndicatorView duration:0.3f options:UIViewAnimationOptionCurveEaseIn animations:^{

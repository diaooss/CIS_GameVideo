...
- (void)setDefaults {
    self.font = [UIFont fontWithName:@"Papyrus" size:15.0f];
...
- (CGRect)frameForSelectionIndicator {
    ...
    if (self.selectionIndicatorMode == HMSelectionIndicatorResizesToStringWidth) {
        ...
        return CGRectMake(x, 25, stringWidth, self.selectionIndicatorHeight);
    } else {
        return CGRectMake(self.segmentWidth * self.selectedIndex, 25, self.segmentWidth, self.selectionIndicatorHeight);
    }
}
